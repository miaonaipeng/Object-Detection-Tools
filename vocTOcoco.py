...
def convert_xmls_to_cocojson(annotation_paths: List[str],
    ...
    for a_path in annotation_paths:
        ...
        for obj in ann_root.findall('object'):
            ...
            if label_name  in ['insulator13', 'insulator15', 'insulator16']:  # 屏蔽类别
                continue
...
def main():
    ...
    parser.add_argument('--ann_dir', type=str, default='E:/Dataset/real_time_dataset/VOCdevkit/VOC2007/Annotations')
    parser.add_argument('--ann_ids', type=str, default='E:/Dataset/real_time_dataset/VOCdevkit/VOC2007/ImageSets/Main/train.txt')
